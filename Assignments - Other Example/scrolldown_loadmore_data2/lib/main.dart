...
class _ExampleWidgetState extends State<ExampleWidget> {
  ...
  List<ListItem> _herosList = [
    ListItem(
      ...
      imagePath:'https://images.indianexpress.com/2021/05/sonu-sood-1200-1.jpg',
      isLocalImage: false,
    ),
    ListItem(
        ...
        setState(() {
          _herosList.addAll([
            ListItem(
              ...
              imagePath:'https://nkhayi.files.wordpress.com/2012/05/009-omkar-nath.jpg',
              isLocalImage: false,
            ),
            ListItem(
            ...
            ListItem(
              ...
              imagePath:'https://www.apjabdulkalamfoundation.org/images/about/abdulkalamprofile.jpg',
              isLocalImage: false,
            ),
          ]);
        });
