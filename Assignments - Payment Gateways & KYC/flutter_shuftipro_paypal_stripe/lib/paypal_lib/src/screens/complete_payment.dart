...
import 'package:shuftipro_kyc/paypal_result_page.dart';
  ...
  complete() async {
    ...
    if (payerID != null) {
      ...
      if (resp['error'] == false)
      {
        ...
        await widget.onSuccess(params); // success
        setState(() {
          loading = false;
          loadingError = false;
        });

        Navigator.push(context, MaterialPageRoute(builder: (context) => PaypalResultPage(params)));
